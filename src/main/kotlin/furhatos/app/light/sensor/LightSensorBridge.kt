...
object LightSensorBridge {
    ...
    private data class BridgeTuning(
        val updateIntervalMs: Long = envLong("LIGHT_UPDATE_INTERVAL_MS") ?: 200L,
        val luxAlpha: Double = envDouble("LIGHT_LUX_ALPHA") ?: 0.40,
        ...
        val brightDeltaMin: Double = envDouble("LIGHT_BRIGHT_DELTA_MIN") ?: 1.0,
        val forceSendMs: Long = envLong("LIGHT_FORCE_SEND_MS") ?: 1200L,
        val skipSmoothing: Boolean = envBool("LIGHT_SKIP_SMOOTHING") ?: true
    )
